...
void SboxM::sage_ext() {
    std::system((std::string("/home/sunpu/miniconda3/bin/conda run -n sage sage ") + sageInPath_ + " > " + sageOutPath_).c_str());
    std::ifstream file_extract;
...
void SboxM::arxSageGen() {
    ...
    std::system((std::string("/home/sunpu/miniconda3/bin/conda run -n sage sage ") + sageIn + " > " + sageOut).c_str());
